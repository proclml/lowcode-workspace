      ...
      urls: [
        {
          key: '设计器',
          value:
            'https://github.com/alibaba/lowcode-demo/tree/main/demo-general',
        },
        {
          key: 'fusion-ui 物料',
          value:
            'https://github.com/alibaba/lowcode-materials/tree/main/packages/fusion-ui',
        },
        {
          key: 'fusion 物料',
          value:
...
const editorView: IPublicTypeEditorView = (ctx, options) => {
  return {
    async init() {
...
editorView.viewName = 'page-editor-view';
editorView.viewType = 'editor';
const pageResourceType: IPublicTypeResourceType = (ctx, options) => {
  return {
    category: '页面',
    defaultViewType: 'page-editor-view',
    defaultTitle: 'title',
    editorViews: [editorView],
  };
};
pageResourceType.resourceName = 'page-resource';
...
export default () => {
  ...
  useEffect(() => {
    (async function main() {
      if (!ref.current) throw Error('container not found');
